...
public class ENGServiceLocator extends org.apache.axis.client.Service implements net.i2cat.csade.life2.backoffice.clientws.a.engservice.ENGService {
    ...
    private java.lang.String ENGServiceSoap_address = "http://84.88.40.54/Life20/Engine/ENGService.asmx";
    ...
    public net.i2cat.csade.life2.backoffice.clientws.a.engservice.ENGServiceSoap getENGServiceSoap() throws javax.xml.rpc.ServiceException {
    ...
    public net.i2cat.csade.life2.backoffice.clientws.a.engservice.ENGServiceSoap getENGServiceSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            net.i2cat.csade.life2.backoffice.clientws.a.engservice.ENGServiceSoapStub _stub = new net.i2cat.csade.life2.backoffice.clientws.a.engservice.ENGServiceSoapStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (net.i2cat.csade.life2.backoffice.clientws.a.engservice.ENGServiceSoap.class.isAssignableFrom(serviceEndpointInterface)) {
                net.i2cat.csade.life2.backoffice.clientws.a.engservice.ENGServiceSoapStub _stub = new net.i2cat.csade.life2.backoffice.clientws.a.engservice.ENGServiceSoapStub(new java.net.URL(ENGServiceSoap_address), this);
                _stub.setPortName(getENGServiceSoapWSDDServiceName());
                return _stub;
            }
        }
