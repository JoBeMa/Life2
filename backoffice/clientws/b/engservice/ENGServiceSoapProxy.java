...
public class ENGServiceSoapProxy implements net.i2cat.csade.life2.backoffice.clientws.b.engservice.ENGServiceSoap {
  private String _endpoint = null;
  private net.i2cat.csade.life2.backoffice.clientws.b.engservice.ENGServiceSoap eNGServiceSoap = null;
  ...
  private void _initENGServiceSoapProxy() {
    try {
      eNGServiceSoap = (new net.i2cat.csade.life2.backoffice.clientws.b.engservice.ENGServiceLocator()).getENGServiceSoap();
  ...
  public net.i2cat.csade.life2.backoffice.clientws.b.engservice.ENGServiceSoap getENGServiceSoap() {
    if (eNGServiceSoap == null)
      _initENGServiceSoapProxy();
  ...
  public int getMpOffers(java.lang.String sql, net.i2cat.csade.life2.backoffice.clientws.b.engservice.holders.ArrayOfMpOfferHolder ret_mpOffers, int start, int count, java.lang.String username, javax.xml.rpc.holders.StringHolder errorMessage) throws java.rmi.RemoteException{
    if (eNGServiceSoap == null)
      _initENGServiceSoapProxy();
    return eNGServiceSoap.getMpOffers(sql, ret_mpOffers, start, count, username, errorMessage);
  }
